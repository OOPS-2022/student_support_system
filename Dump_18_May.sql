CREATE DATABASE  IF NOT EXISTS `sddatabase` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sddatabase`;
-- MySQL dump 10.13  Distrib 8.0.28, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: sddatabase
-- ------------------------------------------------------
...
INSERT INTO `pledges` VALUES (3,'Plagiarism','The pledge serves as acknowledgement from the student that they will not commit plagiarism ','Signed Pledge','/Uploads/Pledges/SignedPledges/1650355918774Plagiarism Pledge.pdf',0),(4,'Collaboration','This pledge discourages unauthorized collaboration','Signed Pledge','/Uploads/Pledges/SignedPledges/1650727033302Collaboration Pledge.pdf',0),(5,'Plagiarism','I will not commit plagiarism on this assignment. I understand that there will be consequences should I ignore this warning','Clicked Pledge',NULL,0);
...
-- Dump completed on 2022-05-18 16:29:54
