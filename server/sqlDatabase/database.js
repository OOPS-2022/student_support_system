...
function Login(email , password, callback){
  return login(email , password, callback , db)
}
//-------------------------------------------------------------end login
...
function ckecklistForSession(sessionId , callback ){
  return checklist.ckecklistForSession(sessionId , callback , db)
}
