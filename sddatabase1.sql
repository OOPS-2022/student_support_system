...
--
-- Host: localhost    Database: sddatabase1
-- ------------------------------------------------------
...
CREATE TABLE `evidence` (
  ...
  `evidence_name` varchar(30) NOT NULL,
  `evidence_desc` varchar(200) DEFAULT NULL,
  `evidence_link` varchar(300) NOT NULL,
...
INSERT INTO `evidence` VALUES (1,'Notes','CGV Notes','/Uploads/Evidence/1651714196407chapter_3_326295119e862312a89ef8c7773f5175.pdf',3),(2,'CGV Notes 2','cheated using notes','/Uploads/Evidence/1651714662507chapter_4_765b91f6d7d68568ace7767da6706c46 (1).pdf',3);
...
CREATE TABLE `meetings` (
  ...
  `meetLink` varchar(250) DEFAULT NULL,
  `stdNo` int NOT NULL,
  `meetDate` varchar(20) NOT NULL,
  PRIMARY KEY (`meeting_id`),
  KEY `stdNo` (`stdNo`),
  CONSTRAINT `meetings_ibfk_1` FOREIGN KEY (`stdNo`) REFERENCES `users` (`user_id`)
...
INSERT INTO `meetings` VALUES (2,'https://test',1,'2022-06-01'),(3,'https://msteams.com',3,'2022-03-04');
...
--
-- Table structure for table `support_evidence`
--

DROP TABLE IF EXISTS `support_evidence`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `support_evidence` (
  `suppevi_id` int NOT NULL AUTO_INCREMENT,
  `suppevi_name` varchar(30) NOT NULL,
  `suppevi_desc` varchar(200) DEFAULT NULL,
  `suppevi_link` varchar(300) NOT NULL,
  `ticket_id` int NOT NULL,
  PRIMARY KEY (`suppevi_id`),
  KEY `ticket_id` (`ticket_id`),
  CONSTRAINT `support_evidence_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `logged_offences` (`ticket_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `support_evidence`
--

LOCK TABLES `support_evidence` WRITE;
/*!40000 ALTER TABLE `support_evidence` DISABLE KEYS */;
/*!40000 ALTER TABLE `support_evidence` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-05-05 12:18:13
